...
contract KaseiCoin is ERC20, ERC20Detailed, ERC20Mintable{ //inherit from ERC20, ERC20Detailed, ERC20Mintable contract
    
    //Inside of your `KaseiCoin` contract, add a constructor with the following parameters: `name`, `symbol`, and `initial_supply`.
    //add a call to the `ERC20Detailed` contract’s constructor, passing the parameters `name`, `symbol`, and `18`. Recall that 18 is the value for the `decimal` parameter.
